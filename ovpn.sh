...
sed -i 's|export KEY_PROVINCE="CA"|export KEY_PROVINCE="Beeggy"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="Beeggy"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="Beeggy"|' /etc/openvpn/easy-rsa/vars
...
sed -i 's|export KEY_OU=changeme|export KEY_OU=EPIPHANY"|' /etc/openvpn/easy-rsa/vars
